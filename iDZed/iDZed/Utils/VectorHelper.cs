        ...
        public static Vector3[] GetVertices(Obj_AI_Hero target, bool forZhonyas = false) //TODO Zhonyas triangular ult
        {
            ...
            if (forZhonyas)
            {
                ...
                Vector2 vertex3 = ObjectManager.Player.ServerPosition.To2D() +
                                  Vector2.Normalize(vertex1 - vertex2).Perpendicular() * Zed._spells[SpellSlot.W].Range;
                Vector2 vertex4 = ObjectManager.Player.ServerPosition.To2D() +
                                  Vector2.Normalize(vertex2 - vertex1).Perpendicular() * Zed._spells[SpellSlot.W].Range;
