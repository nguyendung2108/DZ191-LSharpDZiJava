...
namespace iDzLucian.cleansing
{
    internal static class SummonerSpells
    {
        ...
        public static SummonerSpell Ignite = new SummonerSpell { Names = new[] { "summonerdot" }, Range = 600f };
        public static SummonerSpell Ghost = new SummonerSpell { Names = new[] { "summonerhaste" } };
        public static SummonerSpell Flash = new SummonerSpell { Names = new[] { "summonerflash" }, Range = 400f };
        ...
        public static SummonerSpell Heal = new SummonerSpell { Names = new[] { "summonerheal" } };
        public static SummonerSpell Barrier = new SummonerSpell { Names = new[] { "summonerbarrier" } };
        ...
        public static SummonerSpell Revive = new SummonerSpell { Names = new[] { "SummonerRevive" } };
        public static SummonerSpell Clarity = new SummonerSpell { Names = new[] { "SummonerMana" } };
        ...
        public static SummonerSpell Exhaust = new SummonerSpell { Names = new[] { "SummonerExhaust" }, Range = 650f };
        public static SummonerSpell Cleanse = new SummonerSpell { Names = new[] { "SummonerBoost" } };
